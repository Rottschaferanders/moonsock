...
impl MoonMSG {
    pub fn new(method: MoonMethod, params: MoonParams, id: u32) -> MoonMSG {
        match params {
            MoonParams::None => MoonMSG::MethodID { jsonrpc: JsonRpcVersion::V2_0, method: method, id: id },
    ...
    pub fn gcode(gcode: String, id: u32) -> MoonMSG {
        MoonMSG::new(MoonMethod::PrinterGcodeScript, MoonParams::PrinterGcodeScript { script: gcode.to_string() }, id)
    }
}
...
pub enum MoonParams {
    ...
    PrinterGcodeScript { script: String },
    Count(u32),
    Filename(String),
...
impl Request {
    #[allow(dead_code)]
    pub fn new(method: MoonMethod, params: MoonParams, id: u32) -> Request {
        // match params {
        //     MoonParams::None => Request { jsonrpc: JsonRpcVersion::V2_0, method: method },
